'''
python Henry_plot_log_p\?\?_files_6.py  ' 5 '
 or 
python3 Henry_plot_log_p\?\?_files_6.py  ' 5 '
'''
#!/usr/bin/env python3
import re
import sys
  ...
  with _INPUT_FILE  as f:
      for line in f:
          ...
          if match is not None:
            ...
            #print(i, name[6:31],name[55:62],name[70:73],name[110:117],len(name)) # print require variables
...
#ax.barh(timer_name_num[0:18],total[0:18], height,  color = colors)
#plt.yticks(timer_name_num[0:18], timer_name[0:18])
#ax1.barh(timer_name_1[0:18],ttotal_avg[0:18], height)
...
ax1.set_ylim((0,18))
ax1.grid(True)
fig.savefig('Unsorter.png', bbox_inches='tight')
print (" ")
...
#----------------------------------------------------
# Plot data, Sorted  Ascending order
#----------------------------------------------------
fig, ax2 = plt.subplots()
#ax2.barh(timer_name_2[0:18],ttotal_avg[0:18], height)
...
ax2.set_ylim((0,18))
ax2.grid(True)
fig.savefig('Sorter.png', bbox_inches='tight')
#----------------------------------------------------
